<script lang="ts">
	...
	function isMobileDev() {
		...
		let mobileUserAgent = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
			navigator.userAgent
		);
...
<div id="stats-wrapper">
	<div class="menu">
		...
		<div id="stats-container">
			<label
				for="frames-sec"
				style="display: flex; justify-content: center; color: rgb(61, 169, 252);">{fps} fps</label
			>
		...
		<div id="slider-container">
			{#if isMobileDevice}
				<button
					...
					>Mobile <i class="fa-solid fa-cube"></i> Motion</button
				>
			{/if}
			...
			<button onclick={dropFloor} style="opacity: {floorDrop ? 1 : 0.5};"
				>Floor <i class="fa-solid fa-person-falling"></i> Toggle</button
			>
		</div>
	</div>
</div>
